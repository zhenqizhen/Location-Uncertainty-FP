...
def fingerprinting_1d(rss_meas_, 
    ...
    east_user = ut_data.cal_weighted_averg(east_sel, ll_sel)
    north_user = ut_data.cal_weighted_averg(north_sel, ll_sel)
    height_user = ut_data.cal_weighted_averg(height_sel, ll_sel)
        
    return [east_user, north_user, height_user,ll_sel]
